...
export const researchProjects: ResearchProject[] = [
  ...
  },
  {
    ...
    methodology: [
      ...
      "Generalization tested deliberately across optimizer (SGD/Adam/AdamW), scale (Tiny-ImageNet-200, a 365-class Places365 subsample), and architecture family (MLP-Mixer, Transformer-Encoder) every directional claim computed per independent seed trajectory and tested via an exact binomial sign test.",
    ...
    results: [
      ...
      "The smooth-activation rise generalizes across optimizer, scale, and architecture family; the ReLU-specific decline and a separate universal effective-rank-rise observation turn out to be CNN-specific.",
